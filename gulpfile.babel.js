...
gulp.task('build',
 gulp.series(clean, JSX, gulp.parallel(pages, sass, javascript, images, copy), styleGuide));
...
// Compile JSX into Javascript for React
function JSX() {
...
function watch() {
  ...
  gulp.watch('src/assets/js/**/*.jsx', gulp.series(JSX, browser.reload));
